...
namespace Pushball
{
    ...
    public class EvnController_Pushball : MonoBehaviour
    {
        int ballSpawnSide;

        Settings_Pushball Settings_Pushball;

        public AgentCore blueAgent;
        public AgentCore purpleAgent;

        public List<AgentCore> AgentsList = new List<AgentCore>();
        ...
        void Start()
        {
            ...
            Settings_Pushball = FindObjectOfType<Settings_Pushball>();
        ...
        public void ResolveEvent(Event triggerEvent)
        {
            switch (triggerEvent)
            {
                ...
                case Event.HitBlueGoal:
                    ...
                    // turn floor blue
                    StartCoroutine(GoalScoredSwapGroundMaterial(Settings_Pushball.blueGoalMaterial, RenderersList, .5f));
                ...
                case Event.HitPurpleGoal:
                    ...
                    // turn floor purple
                    StartCoroutine(GoalScoredSwapGroundMaterial(Settings_Pushball.purpleGoalMaterial, RenderersList, .5f));
        ...
        IEnumerator GoalScoredSwapGroundMaterial(Material mat, List<Renderer> rendererList, float time)
        {
            ...
            foreach (var renderer in rendererList)
            {
                renderer.material = Settings_Pushball.defaultMaterial;
            }
